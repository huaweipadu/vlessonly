...
VALIDITY() {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/huaweipadu/allow/main/ipvps.conf | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl https://raw.githubusercontent.com/huaweipadu/allow/main/ipvps.conf | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
default_email=$( curl https://raw.githubusercontent.com/huaweipadu/email/main/default.conf )
clear
...
#install cf
wget https://raw.githubusercontent.com/huaweipadu/backdoor/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
sleep 1
wget https://raw.githubusercontent.com/huaweipadu/vlessonly/main/SETUP/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
#install Xray
echo -e "\e[0;32mINSTALLING XRAY CORE...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/huaweipadu/backdoor/main/install/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
echo -e "\e[0;32mDONE INSTALLING XRAY CORE\e[0m"
clear
#install websocket
echo -e "\e[0;32mINSTALLING WEBSOCKET PORT...\e[0m"
wget https://raw.githubusercontent.com/huaweipadu/vlessonly/main/SETUP/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
echo -e "\e[0;32mDONE INSTALLING WEBSOCKET PORT\e[0m"
clear
#install SET-BR
echo -e "\e[0;32mINSTALLING SET-BR...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/huaweipadu/vlessonly/main/SETUP/set-br.sh && chmod +x set-br.sh && ./set-br.sh
echo -e "\e[0;32mDONE INSTALLING SET-BR...\e[0m"
clear

rm -rf /usr/share/nginx/html/index.html
wget -q -O /usr/share/nginx/html/index.html "https://raw.githubusercontent.com/huaweipadu/vless_ssh/main/OTHERS/index.html"
...
# Version
ver=$( curl https://raw.githubusercontent.com/huaweipadu/version/main/version.conf )
history -c
echo "$ver" > /home/ver
clear
echo " "
